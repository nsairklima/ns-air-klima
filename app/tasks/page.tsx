...
// 1. Számlálók kiszámítása (a return ELŐTT)
        ...
        {!isFormOpen && !editingTaskId ? (
          ...
          >
            ...
            <div className="form-grid">
              ...
              <CustomDateTimePicker label="Tervezett időpont:" value={scheduledAt} onChange={setScheduledAt} />
              <CustomDateTimePicker label="Megvalósult időpont:" value={completedAt} onChange={setCompletedAt} />
            </div>
