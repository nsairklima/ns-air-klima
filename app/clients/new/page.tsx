  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // SIKER: Átirányítunk az új ügyfél adatlapjára (id alapján)
        ...
        <form onSubmit={handleSubmit} style={{ display: "grid", gap: "20px" }}>
          <div>
            ...
            <input 
              style={inputStyle} 
              required 
              placeholder="pl. Kovács Ipari Kft."
              value={formData.name}
          ...
          <div>
            <label style={labelStyle}>Telepítési cím / Székhely</label>
            <input 
              style={inputStyle} 
          ...
          <div>
            <label style={labelStyle}>Megjegyzés az ügyfélhez</label>
            <textarea 
              style={{ ...inputStyle, height: "100px", resize: "vertical" }} 
              placeholder="Speciális kérések, kapukód, stb..."
          ...
          <div style={{ display: "flex", gap: "10px", marginTop: "10px" }}>
            <button type="submit" style={saveButtonStyle}>ÜGYFÉL LÉTREHOZÁSA</button>
